...
static const int64 MAX_MONEY = 10000000000000 * COIN; // DHcoin: maximum of 20M(20000000) coins (given some randomness)
inline bool MoneyRange(int64 nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
static const int COINBASE_MATURITY = 10;//70
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        //return dPriority > COIN * 1440 / 250; // DHcoin: 1440 blocks found a day. Priority cutoff is 1 dhcoin day / 250 bytes.
    	//no fees!!!
    	return false;
    }
